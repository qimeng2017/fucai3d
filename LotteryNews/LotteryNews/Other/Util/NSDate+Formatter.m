...
+ (NSString *)localeDate0_0{
    ...
    NSDateFormatter *inputFormatter = [[NSDateFormatter alloc] init];
    [inputFormatter setLocale:[[NSLocale alloc] initWithLocaleIdentifier:@""] ];
    [inputFormatter setDateFormat:@"yyyy-MM-dd 00:00:00"];
    NSDate* inputDate = [inputFormatter dateFromString:currentDateStr1];
    
    return [NSDate worldTimeToChinaTime:inputDate];
}
//将世界时间转化为中国区时间
+ (NSString *)worldTimeToChinaTime:(NSDate *)date
{
