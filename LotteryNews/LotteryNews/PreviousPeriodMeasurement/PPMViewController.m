...
-(void)setupBasic{
    ...
    CGRect tableViewFrame = CGRectMake(0, 104, kScreenWidth, CGRectGetHeight(self.view.frame)-104-tabBarHeight-64);
    if (_fromTriolionNewViewController) {
       tableViewFrame = CGRectMake(0, 104, kScreenWidth, CGRectGetHeight(self.view.frame)-104-tabBarHeight);
    }
